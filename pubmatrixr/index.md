...
Creates a formatted heatmap displaying **publication co-occurrence
counts** in cells, with **Jaccard distance clustering** for row/column
ordering. Jaccard distance is the clustering method used to group genes
with similar co-occurrence patterns.

**Cell Values**: Publication co-occurrence counts **Clustering Method**:
Jaccard distance calculated as 1 - (intersection/union) based on
...
- **Clustering Method**: Jaccard distance based on presence/absence
  patterns (1 - intersection/union)
...
1.  Create a free NCBI account at
