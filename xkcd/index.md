...
(font_check)](articles/vignettes/font_check.png)

Font availability check (font_check)

![Mother’s Day example (mommy_plot)](articles/vignettes/mommy_plot.png)

Mother’s Day example (mommy_plot)

![Caritas volunteers example
(caritas_plot)](articles/vignettes/caritas_plot.png)
